...
<head>
  ...
  <link rel="stylesheet" href="/payment-flow.css?v=payment-system-20260807-1">
...
<body class="product-page-document" data-product-id="${escapeAttribute(product.id)}" data-product-slug="${escapeAttribute(slug)}">
  ...
  <script src="/payment-flow.js?v=payment-system-20260808-1"></script>
  <script src="/order-confirmation.js?v=payment-whatsapp-20260808-1"></script>
