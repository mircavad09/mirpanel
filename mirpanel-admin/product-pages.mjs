...
<head>
  ...
  <link rel="stylesheet" href="/payment-flow.css?v=payment-whatsapp-20260808-2">
...
<body class="product-page-document" data-product-id="${escapeAttribute(product.id)}" data-product-slug="${escapeAttribute(slug)}">
  ...
  <script src="/payment-flow.js?v=payment-whatsapp-20260808-2"></script>
  <script src="/order-confirmation.js?v=payment-whatsapp-20260808-2"></script>
