...
css = insertBefore(css, '\n\n.support-box-img', infoCss, 'info section css');
...
css = insertBefore(css, '\n}\n\n.premium-splash', mobileInfoCss, 'mobile info section css');
