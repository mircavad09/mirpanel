/* =========================================================
   app.js — Mirpanel (FINAL CLEAN + SCROLL REVEAL + TIKTOK JETON)
   ========================================================= */
...
const DATA = {
  ...
  products: [
...

    {
      ...
      note: "Minimum 500 jeton. 500 jeton = 10 ₼. İstifadəçi adı və Hesapin Şifrəsini qeyd et",
      currency: "₼",
...
const INFO_TEXTS = {
  ...
  spotify: {
    ...
    lines: [
      ...
      "📧 Gmail ünvanı ilə sifariş edilir.",
    ],
  },
  ...
  $("mForm").innerHTML = `
    <div class="mpForm">
      ...
      <div class="mpHint" style="margin-top:10px">
        Spotify sifarişi üçün Gmail ünvanınızı qeyd edin.
      </div>
...
function showTikTokJetonForm(p, plan) {
  ...
  $("mForm").innerHTML = `
    <div class="mpForm">
      ...
      <div style="margin-top:10px">
        <div class="mpLabel"> Hesapın Şifrəsini qeyd et</div>
        <input id="tt_note" class="mpInput" placeholder="Misal- Mirpanel123">
      </div>
