  ...
  products: [
    ...
    },
    {
      ...
      plans: [
        ...
        { months: 3, label: "3 aylıq", price: 16.99 },
    ...
    },
    {
      ...
      plans: [
        ...
        { months: 3, label: "3 aylıq", price: 12.80 },
        { months: 6, label: "6 aylıq", price: 23.90 }
      ]
    },
    {
      id: "prime",
...
/* =========================
   ✅ INFO BOX CONTENT (sağ yuxarı qutu)
   ========================= */
const INFO_TEXTS = {
  capcut: {
  ...
  adobecc: {
    ...
    lines: [
      ...
      "🖥️ Photoshop, Illustrator, Premiere Pro, After Effects, Acrobat, Lightroom və s.",
...
function openModal(p){
  ...
  renderInfoBox(p); // ✅ plan seçmədən əvvəl göstər
  ...
  // ✅ chips tam silinib (sən istəmirdin)
