/* =========================
   ...
   - Modalda “haqqında” üçün: #mInfo
   - Formların çıxması üçün: #mForm
   - Netflix Şəxsi: Ad + 4 rəqəmli kod (2255)
   - Netflix Ümumi: 1 ay 3.99₼, FORM YOX (birbaşa WhatsApp)
   - YouTube: “Stokta yoxdur” (WhatsApp açılmır)
...
function openModal(p) {
  ...
  // ✅ form sahəsini sıfırla
  $("mForm").innerHTML = "";

  // ✅ plan active sıfırlansın
  $("mPlans").innerHTML = "";
  ...
  if (!plans.length) {
    ...
    plans.forEach((pl) => {
      ...
      d.addEventListener("click", () => {
        ...
        // ✅ form sahəsini sıfırla (hər plan seçəndə)
        $("mForm").innerHTML = "";
        ...
        // Netflix Ümumi / CapCut / Adobe və s.: birbaşa WhatsApp
        openWhatsApp(p, pl);
      });
